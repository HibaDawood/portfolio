        ...
        <div className="flex rounded-lg h-full bg-red-50 p-8 flex-col">
          ...
          <div className="flex-grow">
            <div className='relative h-1 w-full bg-gray-400 rounded-xl'>
              <div className='absolute bg-red-500 h-1 rounded-xl w-[100%]'>
    ...
    {/* skill 2 */}
      <div className="p-4 w-[100%] md:w-1/3">
        <div className="flex rounded-lg h-full bg-red-50 p-8 flex-col">
          ...
          <div className="flex-grow">
            <div className='relative h-1 w-full bg-gray-400 rounded-xl'>
              <div className='absolute bg-red-500 h-1 rounded-xl w-[95%]'>
    ...
    {/* skill 3 */}
      <div className="p-4 w-[100%] md:w-1/3">
        <div className="flex rounded-lg h-full bg-red-50 p-8 flex-col">
          ...
          <div className="flex-grow">
            <div className='relative h-1 w-full bg-gray-400 rounded-xl'>
              <div className='absolute bg-red-500 h-1 rounded-xl w-[75%]'>
    ...
    {/* skill 4 */}
      <div className="p-4 w-[100%] md:w-1/3">
        <div className="flex rounded-lg h-full bg-red-50 p-8 flex-col">
          ...
          <div className="flex-grow">
            <div className='relative h-1 w-full bg-gray-400 rounded-xl'>
              <div className='absolute bg-red-500 h-1 rounded-xl w-[98%]'>
    ...
    {/* skill 5 */}
      <div className="p-4 w-[100%] md:w-1/3">
        <div className="flex rounded-lg h-full bg-red-50 p-8 flex-col">
          ...
          <div className="flex-grow">
            <div className='relative h-1 w-full bg-gray-400 rounded-xl'>
              <div className='absolute bg-red-500 h-1 rounded-xl w-[50%]'>
